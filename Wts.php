...
if(empty($pno)||empty($Ext)||empty($date)||empty($fault)||empty($dept)||empty($dev)||empty($loc)){
...
<body>
	...
	<div id="bod">
		...
		<h2>Workshop Support ticketing</h2>
		...
		<td><label for="PNO">
			...
			<label for="PENO">
				<span>Ext. No.</span>
				<input type="text" id="PENO" name="PENO">
			</label></td></tr>
			...
			<label for="device">
				<span>Device</span>
				<select id="device" name="device" style="margin:15px 0 15px 15px;">
				<option></option>
				...
				<input type="text" id="info" name="info" Placeholder="(OPTIONAL)" style="Margin-left:5px;">
			</label></td>
                <td><label for="fault">
				<span>Fault</span>
				<input type="text" id="fault" name="fault" style="Margin-left:15px;">
			</label></td>
                </tr>       
				</select>
		 	</label></td></tr>
