                ...
                <div class="ibox-content">
                    <table id="trans_table"  class="table table-striped">
                       ...
                       <?php 
                          ...
                          $query= "SELECT DISTINCT product.P_id, Name, Description, Orderlev, product.Quantity from product, activity WHERE product.P_id=activity.P_id GROUP BY product.P_id";
